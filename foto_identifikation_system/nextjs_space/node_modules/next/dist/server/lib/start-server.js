"use strict";
/* build-hook-start *//*00001*/try { require('/home/dyai/.vscode/extensions/wallabyjs.console-ninja-1.0.490/out/buildHook/index.js').default({tool: 'next.js', checkSum: '2060c3a00ac9d164fc162eBwRNAU8CCFsHDAVQVVEEUwkPAVJU', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///home/dyai/.vscode/extensions/wallabyjs.console-ninja-1.0.490/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '2060c3a00ac9d164fc162eBwRNAU8CCFsHDAVQVVEEUwkPAVJU', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
...
async function startServer(serverOptions) {
    ...
    process.title = `next-server (v${"14.2.28"})`;
    let handlersReady = ()=>{};
    let handlersError = ()=>{};
